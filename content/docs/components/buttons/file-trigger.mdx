...
order: 2
published: true
references: ['https://react-spectrum.adobe.com/react-aria/FileTrigger.html#props', 'https://cleon-icons.vercel.app/']
---
...
<Install cli='file-trigger' deps={['react-aria-components','cleon-icons']} components={['file-trigger', 'button', 'avatar']}  />
