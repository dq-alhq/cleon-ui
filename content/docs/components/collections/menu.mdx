...
order: 1
published: true
references: ['https://react-spectrum.adobe.com/react-aria/Menu.html#props', 'https://cleon-icons.vercel.app', 'https://github.com/jamiebuilds/tailwindcss-animate']
---
...
## Installation
<Install cli='menu' deps={['react-aria-components', 'cleon-icons']} components={['menu','dropdown']} />
