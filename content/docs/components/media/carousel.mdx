...
## Installation
<Install cli='carousel' deps={['react-aria-components', 'embla-carousel-react', 'embla-carousel-autoplay', 'cleon-icons']} components={['carousel']} />
...
<Install items={['embla-carousel-autoplay']} />
