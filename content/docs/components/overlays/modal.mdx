...
order: 1
published: true
references: ['https://react-spectrum.adobe.com/react-aria/Modal.html#props', 'https://github.com/jamiebuilds/tailwindcss-animate', 'https://getjustd.com/icons/']
---
...
<Install items={['react-aria-components', 'tailwindcss-animate', 'justd-icons']} />
