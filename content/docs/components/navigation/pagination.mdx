...
order: 3
references: ['https://react-spectrum.adobe.com/react-aria/Link.html#props', 'https://cleon-icons.vercel.app', '/docs/components/buttons/button#variations']
published: true
---
...
<Install cli='pagination' deps={['react-aria-components', 'cleon-icons']} components={['pagination', 'button', 'separator', 'field']} />

## Simple
The simple pagination setup doesn’t display page numbers, using only basic arrow navigation.
<How isCenter={false} toUse="navigation/pagination-simple-demo" />
